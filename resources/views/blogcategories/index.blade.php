...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
	   	 	<div class="col-md-6">
				@if($access['is_add'] ==1)
		   		<a href="{{ URL::to('blogcategories/update') }}" class="tips btn btn-sm btn-white"  title="{{ Lang::get('core.btn_create') }}">
				...
				<a href="{{ URL::to('blogcategories/download') }}" class="tips btn btn-sm btn-white" title="{{ Lang::get('core.btn_download') }}">
	 ...
	 {!! Form::open(array('url'=>'blogcategories/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 <td>
						...
						<a href="{{ URL::to('blogcategories/show/'.$row->id.'?return='.$return)}}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
						@endif
						@if($access['is_edit'] ==1)
						<a  href="{{ URL::to('blogcategories/update/'.$row->id.'?return='.$return) }}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
						@endif
