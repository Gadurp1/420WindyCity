...
class ProductsController extends Controller {
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			{
				$return = 'products/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'products?return='.self::returnUrl();
			}
			...
			return Redirect::to('products/update/'.$id)->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
